...
{
    public class ViewOrderResponse : WMResponseModel
    {
        ...
        {
            return this.TransactionID + this.InvoiceID + this.TotalAmount + this.CustomerName + this.CustomerAddress
                + this.CustomerGender + this.CustomerEmail + this.CustomerPhone
